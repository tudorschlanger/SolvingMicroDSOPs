...
\ifthenelse{\boolean{demacro}}{
  ...
  \usepackage{SolvingMicroDSOPs-clean}}{}
...
\ifthenelse{\boolean{demacromore}}{
  \usepackage{SolvingMicroDSOPs-clean}}{} % demacro most things
...
%\econarkmultibib{\texname}\end{document}\endinput % \endinput prevents any processing of subsequent stuff
