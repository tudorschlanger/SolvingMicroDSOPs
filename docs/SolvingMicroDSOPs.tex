...
\ifthenelse{\boolean{demacromore}}{
  % replace as much as possible from econark
  \usepackage{SolvingMicroDSOPs-econark}}{}
...
%\input{bibliography-blend}\end{document}\endinput % \endinput prevents any processing of subsequent stuff
